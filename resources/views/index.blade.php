...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container d-flex justify-content-between">
      <div class="contact-info">
        <ul>
          <li><i class="icofont-envelope"></i><a href="mailto:contact@cacahuarte@gmail.com">cacahuarte@gmail.com</a></li>
  ...
  <header id="header">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html"><span>CACAHUARTE</span></a></h1>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Contamos con BPA</h4>
                    <p>BPA son buenas practicas de produccion agricola haciendo que nuestros productos sean unicos</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-cube-alt"></i>
                    <h4>Analsis sensorial</h4>
                    <p>podras saber de la composicion del cacao y todo los valores agregados de el analisis realizado</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-images"></i>
                    <h4>Galeria de campo</h4>
                    <p>Aqui podras conocer un poco mas sobre nuestro emprendimiento</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <h3 data-aos="fade-up">Equipo de mujeres emprendedoras</h3>
            <p data-aos="fade-up">somos un grupo de mujeres emprendedoras del municipio de elias huila, queremos mejorar nuestra region y a partir de nuestra riqueza agricola ofrecer un producto de calidad para el consumo en el hogar u oficina</p>

            <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"></i></div>
              <h4 class="title"><a href="">100% Natural</a></h4>
   ...
   <!--  <section id="services" class="services section-bg">
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p data-aos="fade-up">Estos son todos los productos que hemos producido con nuestro emprendimiento que ya mismpo puedes pedir y comprar con nosotros</p>
        </div>
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-up">Equipo de mujeres</h2>
    ...
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p data-aos="fade-up">Nuestros precios se ajustan a la mano de obra que administramos para llevar siempre lo mejor y al mejor precio</p>
        </div>
